...
def createBigram(data):
    ...
    for i in range(len(data)):
        ...
        if data[i] in unigramCounts:
            ...
            unigramCounts[data[i]] = 1
    print(listOfBigrams, unigramCounts, bigramCounts)
...
if __name__ == '__main__':
    ...
    bigramGoodTuring, zeroOccurenceProb, goodTuringCstar = goodTuringDiscounting(listOfBigrams, bigramCounts,
                                                                                 len(listOfBigrams))
    ...
    for i in range(len(inputList)):
        if inputList[i] in bigramProb:
            output1.write(str(inputList[i]) + '\t\t' + str(bigramCounts[inputList[i]]) + '\t\t' + str(
    ...
    for i in range(len(inputList)):
        if inputList[i] in bigramAddOne:
            output2.write(str(inputList[i]) + '\t\t' + str(addOneCstar[inputList[i]]) + '\t\t' + str(
    ...
    for i in range(len(inputList)):
        if inputList[i] in bigramGoodTuring:
            output3.write(str(inputList[i]) + '\t\t' + str(goodTuringCstar[inputList[i]]) + '\t\t' + str(
                bigramGoodTuring[inputList[i]]) + '\n')
