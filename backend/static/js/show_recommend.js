                ...
                $.ajax({
                    ...
                    success: (function (data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            ...
                            tr += "<td>" + "<button  class=\"btn btn-success btn-xs button_checkWord_newword\" " +
                                "id=\"button_checkWord_newword\" for='1' value='" + data[i][0] + "'>ถูก</button>" + "</td>"

                            tr += "<td>" + "<button class=\"btn btn-danger btn-xs button_checkWord_newword\" " +
                                "id=\"button_checkWord_newword\" for ='-1' value='" + data[i][0] + "'>ผิด</button>" + "</td>"
